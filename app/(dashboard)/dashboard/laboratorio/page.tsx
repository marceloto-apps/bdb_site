...
import { r2Configurado, variaveisR2Faltando } from '@/lib/laboratorio/data/r2'
...
export default async function LaboratorioPage() {
  ...
  return <LaboratorioClient datasetDisponivel={r2Configurado()} variaveisFaltando={variaveisR2Faltando()} />
}
